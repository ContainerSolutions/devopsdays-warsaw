...
version_a_200 = [x for x in results if x["metric"]["destination_version"] == "v1" and x["metric"]["response_code"]=="200"][0]["value"][1]
version_a_500 = [x for x in results if x["metric"]["destination_version"] == "v1" and x["metric"]["response_code"]=="500"][0]["value"][1]
